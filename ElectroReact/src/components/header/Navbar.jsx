      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-primary ">
        ...
        <div className="collapse navbar-collapse" id="navbarCollapse">
          <div className="navbar-nav ms-auto py-0">
            ...
            <Link to={'/shop/laptops'} href="shop.html" className="nav-item nav-link">Shop</Link>
            <Link to={'/singlepage'} href="single.html" className="nav-item nav-link">Single Page</Link>
            <div className="nav-item dropdown">
              <a href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
              <div className="dropdown-menu m-0">
                <Link to={'/bestseller'} href="bestseller.html" className="dropdown-item">Bestseller</Link>
                <Link to={'/cartpage'} href="cart.html" className="dropdown-item">Cart Page</Link>
                <Link to={'/cheackout'} href="cheackout.html" className="dropdown-item">Cheackout</Link>
                <Link to={'/error404'} href="404.html" className="dropdown-item">404 Page</Link>
              </div>
            </div>
            <Link to={'/contactos'} href="contact.html" className="nav-item nav-link me-2">Contact</Link>
            <div className="nav-item dropdown d-block d-lg-none mb-3">
              <Link to={'/allcategory'} href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">All Category</Link>
              <div className="dropdown-menu m-0">
                <ul className="list-unstyled categories-bars">
                  <li>
                    <div className="categories-bars-item">
                      <Link to={'/accessories'} href="#">Accessories</Link>
                      <span>(3)</span>
                    </div>
                  </li>
                  <li>
                    <div className="categories-bars-item">
                      <Link to={'/electronic'} href="#">Electronics &amp; Computer</Link>
                      <span>(5)</span>
                    </div>
                  </li>
                  <li>
          ...
          <a href className="btn btn-secondary rounded-pill py-2 px-4 px-lg-3 mb-3 mb-md-3 mb-lg-0"><i className="fa fa-mobile-alt me-2" /> +58 412 1369796</a>
        </div>
      </nav>
    </div>
  </div>
